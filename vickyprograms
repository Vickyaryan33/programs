i/*Write a program in Embedded C for 8051 microcontroller to find the sum
...
19./*Interface a common cathode 7 segment display with Port 1 and a key at INTO pin. Write code in embedded C such that the count 
on the display is incremented every time the key is pressed. Further, once the count reaches 9 then it rolls over to 0. Use 
interrupt Assume crystal of 12MHz*/


#include<reg52.h>
xdata unsigned char dispcode[10] ={0xC0,0xF9,0xA4,0xB0,0x99,0x92,0x82,0xF8,0x80,0x90};
xdata unsigned char i _at_ 0x2008;
unsigned char *ptr;
sbit k1 = P3^2;
void main(){
	i=0;k1=1;
